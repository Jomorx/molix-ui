...
var fe = defineComponent({
    ...
    setup(t) {
        const o = t,
            e = A(),
            { isCodeFold: c, setCodeFold: i } = E(),
            { copyContent: p, clickCopy: h } = I(),
            C = ref(decodeURIComponent(o.code)),
            m = ref(decodeURIComponent(o.showCode)),
            r = ref(null),
            w = () => {
                h(C.value), j.open();
            },
...
export { fe as AntDesignContainer, ke as ElementPlusContainer };
